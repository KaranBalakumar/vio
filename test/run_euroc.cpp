...
#include <stdlib.h>
#include <string.h>
#include <iostream>   // It is the I/O stream control header file, similar to formatted output in C.
#include <thread>
#include <iomanip>
...
int main(int argc, char **argv)
{
	...
	// 		<< "For example: ./run_euroc /home/karan/dataset/EuRoC/MH-05/mav0/ ../config/"<< endl;
	// 	return -1;
	// }
	// sData_path = argv[1];
	// sConfig_path = argv[2];
