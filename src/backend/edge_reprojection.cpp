...
/*    
    ...
    VecX residual_;                 // Residuals (difference between the predicted and observed values)
    std::vector<MatXX> jacobians_;  // Jacobians, each Jacobian has dimensions residual x vertex[i]
    MatXX information_;             // Information matrix (often the inverse of the covariance matrix)
    VecX observation_;              // Observation data (the measured values corresponding to the residuals)
*/
