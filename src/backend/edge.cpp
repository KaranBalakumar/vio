...
Edge::Edge(int residual_dimension, int num_verticies,
    ...
    //verticies_.resize(num_verticies);      // TODO:: There may be an issue here. For example, if we resize to 3 empty elements, and later call edge->addVertex,
//       it might result in empty elements at the front of the vertex array.
...
//    return residual_.transpose() * residual_;   // When calculating the residual, sqrt_info has already been multiplied. Do not multiply by it again here.
}
